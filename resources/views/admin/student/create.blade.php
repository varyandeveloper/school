        ...
        <form method="post" action="{{route('students.store')}}">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="student_dob" class="col-form-label">DOB</label>
                            <input class="form-control date-picker @error('dob') is-invalid @enderror" id="student_dob" name="dob" type="text">
                            @error('dob')
                            <small class="text-danger">{{$message}}</small>
                            @enderror
                        </div>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('password') is-invalid @enderror" id="student_password" name="password" type="text">
                            @error('password')
                            <small class="text-danger">{{$message}}</small>
                            @enderror
                        </div>
